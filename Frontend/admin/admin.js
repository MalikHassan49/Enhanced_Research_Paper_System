...
addTeacher.addEventListener("click", () => {
  ...
  setTimeout(() => {
    window.location.href = "../add-teacher/addTeacher.html";
  }, 100)
})
...
allTeachers.addEventListener("click", () => {
  ...
  setTimeout(() => {
    window.location.href = "../all-teachers/allTeachers.html";
  }, 100)
})
...
allStudents.addEventListener("click", () => {
  ...
  setTimeout(() => {
    window.location.href = "../all-students/allStudents.html";
  }, 100)
})
...
allPapers.addEventListener("click", () => {
  ...
  setTimeout(() => {
    window.location.href = "../all-papers/allPapers.html";
  }, 100)
})
