...
import { submitPaper, studentAllPapers, allSubmittedPapers, reviewPaper, comment, reviewedPapers, deletePaper, papersStatus, assignTeacher, allPapers  } from "../controllers/paper.controller.js";
...
router.route("/all-papers").get(verifyJWT, allPapers);
